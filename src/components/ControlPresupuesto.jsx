...
const ControlPresupuesto = ({ gastos, presupuesto, onReset }) => {
  ...
  const handleReset = () => {
    const isuserConfirm = confirm(
      "¿Estás seguro de que deseas resetear la aplicación? Los gastos y el presupuesto se perderán."
    );

    if (isuserConfirm) onReset();
  };
